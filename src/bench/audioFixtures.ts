...
export const AUDIO_FIXTURE_IDS = ['cluster-ff', 'cluster-mf', 'stack-185', 'pedal-piece'] as const
...
const CLUSTER_PITCHES = [48, 52, 55, 59, 62, 67, 72, 76]
...
export function buildSyntheticFixture(id: Exclude<AudioFixtureId, 'pedal-piece'>): MidiFile {
  switch (id) {
    case 'cluster-ff':
