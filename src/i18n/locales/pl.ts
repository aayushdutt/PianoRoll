...
const pl: Messages & Record<PolishPluralKey, string> = {
  ...
  'learn.pa.speedLabel': 'Tempo',
  'learn.pa.speedCycleAria': 'Tempo {speed} - kliknij, aby zmienić',
  'learn.pa.speedCycleTip': 'Tempo · kliknij, aby zmienić, shift+klik cofa',
  ...
  'learn.pa.loopClearLabel': 'Usuń pętlę',
