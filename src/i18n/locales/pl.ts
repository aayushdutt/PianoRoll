...
const pl: Messages & Record<PolishPluralKey, string> = {
  ...
  'visualization.guitar.aria': 'Pokaż wizualizację gitary',
  'visualization.learnPianoRequired': 'Ta aktywność nauki wymaga widoku fortepianu.',
  'guitar.fretboard.aria': 'Interaktywny gryf gitary',
  'guitar.fretboard.position': 'Struna {string}, próg {fret}, nuta {note}',
  'guitar.unsupportedNote': '{note} znajduje się poza tym gryfem',
  'guitar.unsupportedNotes': 'Nie można umieścić {count} nut na tym gryfie',
